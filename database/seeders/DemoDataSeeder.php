...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $documentos = [
            ...
            // ── INSTRUCTIVOS ──────────────────────────────────────
            [
                'titulo' => 'Instructivo para Diligenciamiento de la Matriz Integral F-16',
                'codigo' => 'HSEQ-GCA1-I-3',
                'descripcion' => 'Guía paso a paso para el correcto diligenciamiento del formato HSEQ-GCA1-F-16 (Matriz Integral de Control Documental), incluyendo ejemplos de casos reales.',
                ...
                'version_actual' => 2,
                'tags' => ['instructivo', 'f-16', 'matriz-integral'],
                'confidencial' => false,
                'visitas' => 318,
            ],
            [
            ...
            // ── FORMATOS ──────────────────────────────────────────
            [
                'titulo' => 'Matriz Integral de Control Documental — F-16',
                'codigo' => 'HSEQ-GCA1-F-16',
                ...
                'version_actual' => 1,
                'tags' => ['formato', 'f-16', 'matriz-integral', 'obligatorio'],
                'confidencial' => false,
                'visitas' => 425,
            ],
            [
        ...
        if ($docPrincipal && $docPrincipal->versiones()->count() === 0) {
            $versiones = [
                ...
                [
                    'documento_id' => $docPrincipal->id,
                    'version' => 3,
                    'cambios' => 'Unificación de formatos F-11, F-12 y F-13 en la nueva Matriz Integral F-16. Actualización de roles acorde al nuevo SGD DICACOCU digital. Eliminación de registro físico obligatorio.',
                    'estado' => 'aprobado',
                    'created_by' => $gestor->id,
                    'aprobado_por' => $superadmin->id,
